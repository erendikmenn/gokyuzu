...
export function activate({ BRIDGES, TIPS, TOUCH_TIPS, TOWERS, setNavData }) {
  ...
  setNavData({
    ...
    traffic: [
      { id: 'GKY7', cx: -21000, cz: -18000, r: 9000, v: 125, alt: 1500, ph: 0.3, dir: 1, kind: 'airliner' },
      { id: 'SKB31', cx: 24000, cz: 16000, r: 6000, v: 110, alt: 900, ph: 2.1, dir: -1, kind: 'airliner' },
      ...
      { id: 'MRM24', cx: 0, cz: -10000, r: 14000, v: 150, alt: 3300, ph: 3.3, dir: -1, kind: 'airliner' },
