...
Elevations: AIP aerodrome elevations. Per runway END (`ends[k].elevation`, m MSL): the published (AIP) end elevations
from OurAirports (public domain runways.csv, cached); the terrain turns them into sloped runways (LTFM falls ~0.9 %
